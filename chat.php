            ...
            <div class="col-7 px-0">
                ...
                <?php
                    if (!empty($_POST["mensaje"]))
                        enviarMensaje($_POST["mensaje"]);
                ?>

                <!-- Typing area -->
                <form action="" method="post" class="bg-light">
                    <div class="input-group">
                        <input type="text" name="mensaje" placeholder="Type a message" aria-describedby="button-addon2" class="form-control rounded-0 border-0 py-4 bg-light">
